...
if(file!=None):
    ...
    st.header(":grey[Basic Information of the Dataset]",divider="rainbow")
    ...
    with tab2:
        ...
        toprows = st.slider("No.of rows you want",1,data.shape[0],key="topslider")
        st.dataframe(data.head(toprows))
        st.subheader(":grey[Bottom 5 rows]")
        bottomrows = st.slider("No.of rows you want",1,data.shape[0],key="bottomslider")
    ...
    with st.expander(":blue[Group by your columns]"):
